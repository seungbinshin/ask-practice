export const modelAnswers = {
  ...
  'intro-6': `제 단점은 긴급한 상황에서 우선순위 판단이 다소 늦어질 때가 있다는 점입니다. 여러 기술 이슈가 동시에 발생하는 환경에서, 하나의 원인을 깊게 분석하다 초기 대응이 늦어진 경험이 있었습니다. 이후에는 임시 대응과 근본 원인 분석을 분리해 먼저 필요한 조치를 빠르게 공유하고, 별도로 구조적 개선을 진행하는 방식으로 보완했습니다. 또한 CI 테스트를 강화해 제가 담당한 코드에서 오류가 사전에 걸러지도록 하면서 재발 가능성도 낮추고 있습니다. 지금은 대응 속도와 안정성을 함께 고려하는 방향으로 일하고 있습니다.`,
