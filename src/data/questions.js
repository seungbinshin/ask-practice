    ...
    intro: {
      ...
      pool: [
        ...
        },
        {
          ...
          keywords: ['축1: HW설계~시스템시뮬 다층적 분석 (게이트↔시스템 연결)', '축2: 상대방 언어로 기술 소통 (AI EXPO 한국어 / JAPAN IT WEEK 일본어 / SEMICON Europa 영어)', '3개국 3개 언어 기술 소통 = 신입 차별화', '목표: 고객 시스템 최적화 + 기술 컨설턴트'],
          guideNotes: '적합성 축1(HW~시스템 다층적 분석, AI 워크로드 병목 체감) → 적합성 축2(3개국 전시회 3개 언어 기술 소통 — 한국어/일본어/영어 구체 사례) → 목표(고객별 아키텍처 이해한 기술 컨설턴트)'
        },
        {
          id: 'intro-3',
        ...
        },
        {
          ...
          keywords: ['AE = 기술 소통이 핵심인 직무 (설계에서는 발휘 어려움)', '3개국 전시회 경험: 언어 달라도 상대방 궁금점 파악→맞춤 설명이 즐거움', 'Creator 전환 → AE 역할 기술 컨설팅 확대', '#소통으로기술의가능성을연결하는엔지니어'],
          guideNotes: 'AE 선택 이유(기술 소통이 가장 몰입되는 순간 → 설계 직무에서는 발휘 어려움 → AE에서는 핵심) → 근거(AI EXPO 한국어/JAPAN IT WEEK 일본어/SEMICON Europa 영어) → SK하이닉스 이유(Creator 전환, AE 역할 확대) → 한마디(소통으로 기술의 가능성을 연결하는 엔지니어)'
        },
        {
          id: 'intro-6',
