export const modelAnswers = {
  ...
  'intro-6': `저의 단점은 스스로 해결할 수 있다는 생각에 주변에 질문하기를 주저하는 경향이었습니다. 입사 초기에 MPE 모듈의 서브블록 설계를 맡았을 때, 바로 옆에 사수님이 계셨는데도 혼자 판단하며 끝까지 진행했습니다. 결과적으로 리뷰에서 설계 방향 자체가 틀렸다는 피드백을 받고 전면 폐기되었고, 그때 정말 좌절했습니다. 이 경험이 저를 크게 바꿨습니다. 이후로는 시작 전에 기대치를 정렬하고, 2~3일 단위로 중간 검토를 받는 체계적이고 주기적인 소통 습관을 만들었습니다. 아직 완전히 극복했다고 말하기는 어렵지만, 의식적으로 소통을 실천하며 개선해나가고 있습니다. AE는 고객, 설계팀 사이의 소통 허브인 만큼, 이 습관이 직무에서도 가장 중요한 기본자세가 될 것이라 생각합니다.`,
